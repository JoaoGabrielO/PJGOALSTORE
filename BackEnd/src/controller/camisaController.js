import { buscarPorNome, listar, remover, salvar, alterar, buscarPorId, alterarCapa } from "../repository/camisaRepository.js";
...
endpoints.put('/camisa/:id/capa', upload.single('capa'), async (req, resp) => {
  let id = req.params.id;
  let caminho = req.file.path;

  if (!req.file) {
    return resp.status(400).send('Nenhum arquivo de imagem enviado.');
  }
